...
goog.require('hickory.utils');
hickory.core.HiccupRepresentable = (function (){var obj9212 = {};return obj9212;
})();
...
hickory.core.HickoryRepresentable = (function (){var obj9214 = {};return obj9214;
})();
...
(hickory.core.as_hiccup["object"] = (function (this$){var pred__9216 = cljs.core._EQ_;var expr__9217 = (this$["nodeType"]);if(cljs.core.truth_(pred__9216.call(null,hickory.core.Attribute,expr__9217)))
...
(hickory.core.as_hickory["object"] = (function (this$){var pred__9219 = cljs.core._EQ_;var expr__9220 = (this$["nodeType"]);if(cljs.core.truth_(pred__9219.call(null,hickory.core.Attribute,expr__9220)))
{return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hickory.utils.lower_case_keyword.call(null,(this$["name"])),(this$["value"])], null);
} else
{if(cljs.core.truth_(pred__9219.call(null,hickory.core.Comment,expr__9220)))
...
{if(cljs.core.truth_(pred__9219.call(null,hickory.core.Document,expr__9220)))
...
{if(cljs.core.truth_(pred__9219.call(null,hickory.core.DocumentType,expr__9220)))
...
{if(cljs.core.truth_(pred__9219.call(null,hickory.core.Element,expr__9220)))
...
{if(cljs.core.truth_(pred__9219.call(null,hickory.core.Text,expr__9220)))
{return (this$["wholeText"]);
} else
{throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__9220)].join('')));
}
}
}
}
...
var temp__4092__auto___9222 = cljs.core.first.call(null,(doc["head"]["childNodes"]));if(cljs.core.truth_(temp__4092__auto___9222))
{var title_el_9223 = temp__4092__auto___9222;if(cljs.core.empty_QMARK_.call(null,(title_el_9223["text"])))
{hickory.core.remove_el.call(null,title_el_9223);
} else
{}
} else
{}
