...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t12974 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t12974 = (function (val,box,meta12975){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t12974.cljs$lang$type = true;
cljs.core.async.impl.channels.t12974.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t12974";
cljs.core.async.impl.channels.t12974.cljs$lang$ctorPrWriter = (function (this__4010__auto__,writer__4011__auto__,opt__4012__auto__){return cljs.core._write.call(null,writer__4011__auto__,"cljs.core.async.impl.channels/t12974");
});
cljs.core.async.impl.channels.t12974.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t12974.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12976){var self__ = this;
var _12976__$1 = this;return self__.meta12975;
});
cljs.core.async.impl.channels.t12974.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12976,meta12975__$1){var self__ = this;
var _12976__$1 = this;return (new cljs.core.async.impl.channels.t12974(self__.val,self__.box,meta12975__$1));
});
cljs.core.async.impl.channels.__GT_t12974 = (function __GT_t12974(val__$1,box__$1,meta12975){return (new cljs.core.async.impl.channels.t12974(val__$1,box__$1,meta12975));
});
}
return (new cljs.core.async.impl.channels.t12974(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_12977 = self__.takes.pop();if((taker_12977 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_12977))
{var take_cb_12978 = cljs.core.async.impl.protocols.commit.call(null,taker_12977);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_12978,taker_12977){
return (function (){return take_cb_12978.call(null,null);
});})(take_cb_12978,taker_12977))
);
} else
{}
{
