...
{try{var G__9477 = new cljs.core.Keyword(null,"type","type",1017479852).cljs$core$IFn$_invoke$arity$1(dom);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"comment","comment",1964302801),G__9477))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"element","element",3646034542),G__9477))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"document-type","document-type",2553302046),G__9477))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"document","document",1875625101),G__9477))
...
}catch (e9476){if((e9476 instanceof Error))
{var e = e9476;throw (cljs.core.truth_(hickory.utils.starts_with.call(null,(e["message"]),"No matching clause: "))?cljs.core.ex_info.call(null,[cljs.core.str("Not a valid node: "),cljs.core.str(cljs.core.pr_str.call(null,dom))].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"dom","dom",1014003892),dom], null)):e);
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e9476;
} else
...
*/
hickory.render.render_hiccup_attrs = (function render_hiccup_attrs(attrs){var attrs_str = clojure.string.join.call(null," ",cljs.core.sort.call(null,cljs.core.filter.call(null,(function (p1__9478_SHARP_){return !(cljs.core.empty_QMARK_.call(null,p1__9478_SHARP_));
}),(function (){var iter__4160__auto__ = (function iter__9487(s__9488){return (new cljs.core.LazySeq(null,(function (){var s__9488__$1 = s__9488;while(true){
var temp__4092__auto__ = cljs.core.seq.call(null,s__9488__$1);if(temp__4092__auto__)
{var s__9488__$2 = temp__4092__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__9488__$2))
{var c__4158__auto__ = cljs.core.chunk_first.call(null,s__9488__$2);var size__4159__auto__ = cljs.core.count.call(null,c__4158__auto__);var b__9490 = cljs.core.chunk_buffer.call(null,size__4159__auto__);if((function (){var i__9489 = 0;while(true){
if((i__9489 < size__4159__auto__))
{var vec__9493 = cljs.core._nth.call(null,c__4158__auto__,i__9489);var k = cljs.core.nth.call(null,vec__9493,0,null);var v = cljs.core.nth.call(null,vec__9493,1,null);cljs.core.chunk_append.call(null,b__9490,((v === true)?[cljs.core.str(cljs.core.name.call(null,k))].join(''):(((v == null))?"":((new cljs.core.Keyword(null,"else","else",1017020587))?[cljs.core.str(cljs.core.name.call(null,k)),cljs.core.str("="),cljs.core.str("\""),cljs.core.str(hickory.utils.html_escape.call(null,v)),cljs.core.str("\"")].join(''):null))));
{
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__9490),iter__9487.call(null,cljs.core.chunk_rest.call(null,s__9488__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__9490),null);
}
} else
{var vec__9494 = cljs.core.first.call(null,s__9488__$2);var k = cljs.core.nth.call(null,vec__9494,0,null);var v = cljs.core.nth.call(null,vec__9494,1,null);return cljs.core.cons.call(null,((v === true)?[cljs.core.str(cljs.core.name.call(null,k))].join(''):(((v == null))?"":((new cljs.core.Keyword(null,"else","else",1017020587))?[cljs.core.str(cljs.core.name.call(null,k)),cljs.core.str("="),cljs.core.str("\""),cljs.core.str(hickory.utils.html_escape.call(null,v)),cljs.core.str("\"")].join(''):null))),iter__9487.call(null,cljs.core.rest.call(null,s__9488__$2)));
}
} else
{return null;
}
...
*/
hickory.render.render_hiccup_element = (function render_hiccup_element(n_element){var vec__9497 = n_element;var tag = cljs.core.nth.call(null,vec__9497,0,null);var attrs = cljs.core.nth.call(null,vec__9497,1,null);var content = cljs.core.nthnext.call(null,vec__9497,2);if(cljs.core.truth_(hickory.utils.void_element.call(null,tag)))
...
* hiccup's.
*/
hickory.render.hiccup_to_html = (function hiccup_to_html(hiccup_forms){return cljs.core.apply.call(null,cljs.core.str,cljs.core.map.call(null,(function (p1__9498_SHARP_){return hickory.render.render_hiccup_form.call(null,hickory.hiccup_utils.normalize_form.call(null,p1__9498_SHARP_));
}),hiccup_forms));
});
