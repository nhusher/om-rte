...
sablono.util.ToString = (function (){var obj9942 = {};return obj9942;
})();
...
sablono.util.ToURI = (function (){var obj9944 = {};return obj9944;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__9945){
...
{var vec__9947 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);var first_word = cljs.core.nth.call(null,vec__9947,0,null);var words = cljs.core.nthnext.call(null,vec__9947,1);if((cljs.core.empty_QMARK_.call(null,words)) || (cljs.core._EQ_.call(null,"aria",first_word)) || (cljs.core._EQ_.call(null,"data",first_word)))
{return k;
} else
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__9948_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__9948_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__9948_SHARP_], null);
} else
{if(cljs.core.sequential_QMARK_.call(null,p1__9948_SHARP_))
...
merge_with_class.cljs$lang$applyTo = (function (arglist__9949){
var maps = cljs.core.seq(arglist__9949);
...
* CSS classes.
*/
sablono.util.match_tag = (function match_tag(s){var matches = cljs.core.re_seq.call(null,/[#.]?[^#.]+/,cljs.core.name.call(null,s));var vec__9953 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",1014018828),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):((new cljs.core.Keyword(null,"default","default",2558708147))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null):null)));var tag_name = cljs.core.nth.call(null,vec__9953,0,null);var names = cljs.core.nth.call(null,vec__9953,1,null);return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,(function (p1__9950_SHARP_){return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__9950_SHARP_));
}),names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,(function (p1__9951_SHARP_){return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__9951_SHARP_));
}),names)))], null);
});
/**
* Ensure an element vector is of the form [tag-name attrs content].
*/
sablono.util.normalize_element = (function normalize_element(p__9954){var vec__9957 = p__9954;var tag = cljs.core.nth.call(null,vec__9957,0,null);var content = cljs.core.nthnext.call(null,vec__9957,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
