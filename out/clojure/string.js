...
{{
var G__9611 = cljs.core.pop.call(null,v__$1);
v__$1 = G__9611;
continue;
}
} else
...
{var pred__9615 = cljs.core._EQ_;var expr__9616 = limit;if(cljs.core.truth_(pred__9615.call(null,1,expr__9616)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__9615.call(null,2,expr__9616)))
...
var G__9618 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__9619 = (limit__$1 - 1);
var G__9620 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__9618;
limit__$1 = G__9619;
parts = G__9620;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___9622 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___9622))
{var replacement_9623 = temp__4090__auto___9622;buffer.append([cljs.core.str(replacement_9623)].join(''));
} else
{buffer.append(ch);
}
{
