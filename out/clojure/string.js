...
{{
var G__9993 = cljs.core.pop.call(null,v__$1);
v__$1 = G__9993;
continue;
}
} else
...
{var pred__9997 = cljs.core._EQ_;var expr__9998 = limit;if(cljs.core.truth_(pred__9997.call(null,1,expr__9998)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__9997.call(null,2,expr__9998)))
...
var G__10000 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10001 = (limit__$1 - 1);
var G__10002 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10000;
limit__$1 = G__10001;
parts = G__10002;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___10004 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___10004))
{var replacement_10005 = temp__4090__auto___10004;buffer.append([cljs.core.str(replacement_10005)].join(''));
} else
{buffer.append(ch);
}
{
var G__10006 = (index + 1);
index = G__10006;
continue;
}
}
